 ...
 * @version 1.0
 */
public class SiteGenApp extends AppTemplate {
    /**
    ...
    public void buildAppComponentsHook() {
        ...
        dataComponent = new SiteGenData(this);
        workspaceComponent = new SiteGenWorkspace(this);
        fileComponent = new SiteGenFile(this);
        styleComponent = new SiteGenStyle(this);
    }
