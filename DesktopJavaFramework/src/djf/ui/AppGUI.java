...
public class AppGUI {
    ...
    protected Pane fileToolbarPane;
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        HBox olderButtons = new HBox();
        HBox newerButtons = new HBox();
        // HERE ARE OUR FILE TOOLBAR BUTTONS, NOTE THAT SOME WILL
        // START AS ENABLED (false), WHILE OTHERS DISABLED (true)
        newButton = initChildButton(olderButtons,	NEW_ICON.toString(),	    NEW_TOOLTIP.toString(),	false);
        loadButton = initChildButton(olderButtons,	LOAD_ICON.toString(),	    LOAD_TOOLTIP.toString(),	false);
        saveButton = initChildButton(olderButtons,	SAVE_ICON.toString(),	    SAVE_TOOLTIP.toString(),	true);
        saveAsButton = initChildButton(olderButtons, SAVE_AS_ICON.toString(),    SAVE_AS_TOOLTIP.toString(),    true);
        exportButton = initChildButton(olderButtons, EXPORT_ICON.toString(),     EXPORT_TOOLTIP.toString(),  true);
        exitButton = initChildButton(olderButtons,	EXIT_ICON.toString(),	    EXIT_TOOLTIP.toString(),	false);
        undoButton = initChildButton(newerButtons, UNDO_ICON.toString(),     UNDO_TOOLTIP.toString(),  true);
        redoButton = initChildButton(newerButtons, REDO_ICON.toString(),     REDO_TOOLTIP.toString(),  true);
        aboutButton = initChildButton(newerButtons, ABOUT_ICON.toString(),     ABOUT_TOOLTIP.toString(),  true);
        newButton.setStyle("-fx-pref-width: 40; -fx-pref-height: 35;");
        loadButton.setStyle("-fx-pref-width: 40; -fx-pref-height: 35;");
        saveButton.setStyle("-fx-pref-width: 40; -fx-pref-height: 35;");
        saveAsButton.setStyle("-fx-pref-width: 40; -fx-pref-height: 35;");
        exportButton.setStyle("-fx-pref-width: 40; -fx-pref-height: 35;");
        exitButton.setStyle("-fx-pref-width: 40; -fx-pref-height: 35;");
        fileToolbarPane.getChildren().addAll(olderButtons, newerButtons);
