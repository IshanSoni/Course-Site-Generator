...
public abstract class AppTemplate extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            alert.setTitle("Choose your preffered language");
            alert.setContentText("Please pick a language of your choice to continue");
            ...
            if (result.get() == buttonTypeTwo)
                ...
                success = loadProperties("app_properties.xml");
