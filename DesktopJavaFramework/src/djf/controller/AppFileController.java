...
import static djf.settings.AppPropertyType.EXPORTED_COMPLETED_MESSAGE;
import static djf.settings.AppPropertyType.EXPORTED_COMPLETED_TITLE;
...
public class AppFileController {
    ...
    public void export() throws IOException {          
        ...
        AppMessageDialogSingleton dialog = AppMessageDialogSingleton.getSingleton();
	PropertiesManager props = PropertiesManager.getPropertiesManager();
        dialog.show(props.getProperty(EXPORTED_COMPLETED_TITLE),props.getProperty(EXPORTED_COMPLETED_MESSAGE));
    }
